...
def submission_checklist() -> str:
    items = [
        ...
        ("Supplementary Figures S1-S8", "final package uses S1-S8; final files require visual review"),
        ...
        ("Data availability", "draft generated; repository URL now set to https://github.com/chenmenghao525-sys/AML-PRFT-Human-Genomics"),
        ("Code availability", "draft generated; repository URL now set to https://github.com/chenmenghao525-sys/AML-PRFT-Human-Genomics; no Zenodo DOI created"),
        ...
        ("Repository URL", "https://github.com/chenmenghao525-sys/AML-PRFT-Human-Genomics"),
        ("ORCID if required", "author confirmation required"),
...
def author_confirmation_rows() -> list[dict[str, str]]:
    return [
        ...
        },
        {
            ...
            "required_for_submission": "yes",
            "current_status": "missing",
            "suggested_text_if_available": "https://github.com/chenmenghao525-sys/AML-PRFT-Human-Genomics",
        ...
        },
        {
            ...
            "required_for_submission": "yes",
            "current_status": "missing",
            "suggested_text_if_available": "https://github.com/chenmenghao525-sys/AML-PRFT-Human-Genomics (no Zenodo DOI created)",
